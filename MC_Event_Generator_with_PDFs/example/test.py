...
def weight(hats, mu, x1, x2, costh_ii):
	...
	w_ii = dsigma(costh_ii, hats, qtype) * ( lhapdf.xfx(x1, mu, 2) *  lhapdf.xfx(-x2, mu, 2) +  lhapdf.xfx(x1, mu, 4) *  lhapdf.xfx(-x2, mu, 4)  )
	w_ii = w_ii + dsigma(-costh_ii, hats, qtype) *  ( lhapdf.xfx(-x1, mu, 2) *  lhapdf.xfx(x2, mu, 2) +  lhapdf.xfx(-x1, mu, 4) *  lhapdf.xfx(x2, mu, 4) )
	qtype = 1 # down-type quarks
	w_ii = w_ii + dsigma(costh_ii, hats, qtype) * ( lhapdf.xfx(x1, mu, 1) *  lhapdf.xfx(-x2, mu, 1) +  lhapdf.xfx(x1, mu, 3) *  lhapdf.xfx(-x2, mu, 3) )
	w_ii = w_ii + dsigma(-costh_ii, hats, qtype) * ( lhapdf.xfx(-x1, mu, 1) *  lhapdf.xfx(x2, mu, 1) +  lhapdf.xfx(-x1, mu, 3) *  lhapdf.xfx(x2, mu, 3) )
